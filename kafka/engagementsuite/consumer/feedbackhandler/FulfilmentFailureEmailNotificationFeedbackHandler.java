...
@Slf4j
public class FulfilmentFailureEmailNotificationFeedbackHandler implements FeedbackHandler {
    ...
    public void handleFailure(FeedbackEvent feedbackEvent) {
        ...
        log.error("""
                FulfilmentFailureEmailNotificationFeedbackHandler [handleSuccess] Engagement Suite: Email related to \
                Bank guarantee fulfilment failure has not been sent to Customer \
    ...
    public void handleSuccess(FeedbackEvent feedbackEvent) {
        ...
        log.info("""
                FulfilmentFailureEmailNotificationFeedbackHandler [handleSuccess] Engagement Suite: Email related to \
                Bank guarantee non stp intake failure request has been successfully sent to Customer \
