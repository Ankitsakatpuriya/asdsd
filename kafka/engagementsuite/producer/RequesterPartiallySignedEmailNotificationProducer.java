...
public class RequesterPartiallySignedEmailNotificationProducer {
    ...
    public void notify(EmailNotificationInput emailNotificationInput) {
        ...
        engagementSuiteGateway.send(notificationEvent, notificationProperties.getRequesterPartiallySignedEmailNotificationProperties().getTopic(),
                createSignCompletionNotificationCallback(notificationEvent, notificationProperties.getRequesterPartiallySignedEmailNotificationProperties()));
    }
    ...
    private Header createHeader(EmailNotificationInput emailNotificationInput) {
        ...
        return Header.builder()
                ...
                .source(NotificationHelper.getSource())
                .metadata(metadata)
                .build();
    }
    ...
    private NotificationEventBody createBody(EmailNotificationInput emailNotificationInput) {
        NotificationPropertiesDetails notificationPropertiesDetails = notificationProperties.getRequesterPartiallySignedEmailNotificationProperties();

        return NotificationEventBody.builder()
                .profileId(emailNotificationInput.getProfileId())
                .communication(SupportedCommunication.REQUESTER_PARTIALLY_SIGN_EMAIL_NOTIFICATION.name())
    ...
    private Map<String, String> prepareBodyParam(EmailNotificationInput emailNotificationInput) {
        ...
        return Map.of(LEGAL_REP_NAME, bgRequest.getInstructingParty().getIndividual().getIndividualName().getFullName(),
