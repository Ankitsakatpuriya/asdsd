...
public class CustomerEmailNotificationProducerTest {
    ...
    void setup() {
        ...
        notificationProperties.setCustomerEmailNotificationProperties(nonStpProperties);
        customerEmailNotificationProducer = new CustomerEmailNotificationProducer(notificationProperties, engagementSuiteGateway);
        ReflectionTestUtils.setField(customerEmailNotificationProducer, "environment", PRD_ENV);
    }
    ...
    void notifyPositive() {
        ...
        customerEmailNotificationProducer.notify(nonStpEmailNotificationInput);
        ...
        assertThat(notificationRequest.getBody().getCommunication()).isEqualTo(SupportedCommunication.CUSTOMER_EMAIL_NOTIFICATION.name());
    ...
    void notifyError() {
        ...
        try (MockedStatic<InetAddress> inetAddressMockedStatic = mockStatic(InetAddress.class)) {
            ...
            bankGuaranteeRequest.getBgRequest().setStpResultDataSet(stpResultDataset);
            EmailNotificationInput nonStpEmailNotificationInput = MockHelper.getNonStpNotificationInput(bankGuaranteeRequest, List.of(document));
            BgosException exception = assertThrows(BgosException.class, () -> customerEmailNotificationProducer.notify(nonStpEmailNotificationInput));
    ...
    @Test
    void notifyCustomerCCAddressCheck() {
