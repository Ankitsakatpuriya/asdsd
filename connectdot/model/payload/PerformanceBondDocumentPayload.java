...
public class PerformanceBondDocumentPayload extends BaseDocumentPayload {
    ...
    @JsonProperty("bgAmount50_1")
    private Double bgFiftyPercentAmountRoundedUp;

    @JsonProperty("bgAmount50_2")
    private Double bgFiftyPercentAmountRoundedDown;

    @JsonProperty("amountinLetterRoundedUp")
    private Double amountInLetterRoundedUp;

    @JsonProperty("amountinLetterRoundedDown")
    private Double amountInLetterRoundedDown;
