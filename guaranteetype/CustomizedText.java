...
@NoArgsConstructor
@AllArgsConstructor
public class CustomizedText implements BaseGuaranteeType {
    ...
    private BankGuaranteeCode subBgCode;
    ...
    public boolean validate(ConstraintValidatorContext context) {
        ...
        log.info("CustomizedText [validate] validating Customized Text  all fields ");
