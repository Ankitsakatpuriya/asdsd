...
@NoArgsConstructor
@AllArgsConstructor
public class PromisePublicContract implements BaseGuaranteeType {
    ...
    public boolean validate(ConstraintValidatorContext context) {
        ...
        log.info("Public Contract Promise [validate] validating Public Contract Promise all fields ");
        ...
        if (ObjectUtils.isEmpty(title)) {
            context.buildConstraintViolationWithTemplate("title of the public contract must not be empty or null").addConstraintViolation();
            validationResult = false;
        }
