...
@NoArgsConstructor
@AllArgsConstructor
public class MoneyRetentionBond implements BaseGuaranteeType {
    ...
    public boolean validate(ConstraintValidatorContext context) {
        ...
        log.info("MoneyRetentionBond [validate] validating Money Retention Bond  all fields ");
        if (isBlank(contractDescription)) {
