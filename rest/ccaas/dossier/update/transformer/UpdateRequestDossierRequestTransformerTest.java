...
class UpdateRequestDossierRequestTransformerTest {
    ...
    void transformTest() {
        ...
        Request request = new UpdateRequestDossierRequestTransformer(URL_FORMAT).transform(updateDossierDataInput);
