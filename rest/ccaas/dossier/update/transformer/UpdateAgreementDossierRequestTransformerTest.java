...
class UpdateAgreementDossierRequestTransformerTest {
    ...
    void transformTest() {
        ...
        Request request = new UpdateAgreementDossierRequestTransformer(URL_FORMAT).transform(updateDossierDataInput);
